...
export OSH='/home/x-zmen/.oh-my-bash'
...
source /home/x-zmen/.bazel/bin/bazel-complete.bash
...
bind 'set vi-ins-mode-string \1\e[6 q\2'  # Vertical bar cursor for insert
bind 'set vi-cmd-mode-string \1\e[2 q\2'  # Block cursor for command

# Optional: Add color to mode indicators
bind 'set vi-ins-mode-string "\1\e[32m\2(ins)\1\e[0m\2"'  # Green (ins)
bind 'set vi-cmd-mode-string "\1\e[31m\2(cmd)\1\e[0m\2"'  # Red (cmd)
